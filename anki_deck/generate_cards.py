...
basic = [
    ...
    ("Grundlagen",
     ...
     "Ein <b>Vertrag</b> über den zukünftigen Kauf oder Verkauf eines Basiswerts (z.&nbsp;B. einer Aktie) zu einem vorher festgelegten Preis.<br><br>Der Käufer erhält ein <b>Recht</b> – keine Pflicht.",
     "grundlagen"),

    ("Grundlagen",
     "Was ist ein <b>Call</b> (Kaufoption)?",
     "Das <b>Recht, die Aktie zu kaufen</b> – zu einem festen Preis.<br><br>🧠 Merkbild: <b>Call = Reservierung.</b> Du sicherst dir heute den Kaufpreis für später.<br>Der Käufer erwartet <b>steigende</b> Kurse.",
     "grundlagen call"),

    ("Grundlagen",
     "Was ist ein <b>Put</b> (Verkaufsoption)?",
     "Das <b>Recht, die Aktie zu verkaufen</b> – zu einem festen Preis.<br><br>🧠 Merkbild: <b>Put = Versicherung.</b> Du sicherst dich gegen fallende Kurse ab.<br>Der Käufer erwartet <b>fallende</b> Kurse.",
     "grundlagen put"),
    ...
    ("Grundlagen",
     "Was ist der <b>Basiswert</b> (Underlying)?",
     "Die Aktie oder der Wert, auf den sich die Option bezieht (z.&nbsp;B. Apple).",
     "grundlagen begriffe"),

    ("Grundlagen",
     "Was ist der <b>Strike</b> (Ausübungspreis)?",
     "Der vereinbarte Preis, zu dem die Aktie gekauft oder verkauft werden darf.",
     "grundlagen begriffe strike"),

    ("Grundlagen",
     "Was ist die <b>Prämie</b> einer Option?",
     "Der <b>Preis der Option</b> selbst.<br><br>Der <b>Käufer zahlt</b> sie, der <b>Verkäufer erhält</b> sie.",
     "grundlagen begriffe praemie"),

    ("Grundlagen",
     "Wie viele Aktien umfasst <b>1 Optionskontrakt</b>?",
    ...
    ("Grundlagen",
     "Warum sind <b>Optionen</b> <u>nicht</u> dasselbe wie <b>Optionsscheine</b>?",
     "<b>Optionen</b> werden direkt an einer <b>Terminbörse</b> gehandelt – kein Emittenten-Ausfallrisiko.<br><br><b>Optionsscheine/Zertifikate</b> kaufst du von einer <b>Bank</b>. Geht die Bank pleite, ist dein Geld in Gefahr.",
     "grundlagen abgrenzung"),

    ("Grundlagen",
     "Wann ist ein <b>Call</b> „im Geld“ (<b>ITM</b>)?",
     "Wenn der <b>Kurs über dem Strike</b> liegt.<br><br>Beispiel: Aktie 65&nbsp;$, Strike 60&nbsp;$ → der Call ist 5&nbsp;$ im Geld.",
     "grundlagen moneyness itm"),

    ("Grundlagen",
     "Wann ist ein <b>Put</b> „im Geld“ (<b>ITM</b>)?",
    ...
    ("Grundlagen",
     ...
     "<b>ITM</b> = Im Geld (In The Money)<br><b>ATM</b> = Am Geld (Kurs ≈ Strike)<br><b>OTM</b> = Aus dem Geld (Out of The Money)<br><br>Faustregel: <b>ITM</b> ist teuer (hat echten Wert), <b>OTM</b> ist billig (nur Hoffnung).",
     "grundlagen moneyness"),

    # --- 2. Käufer / Verkäufer & Grundpositionen ---------------------------
    ("Käufer & Verkäufer",
     "Unterschied <b>Käufer (Long)</b> und <b>Verkäufer (Short)</b>?",
     "<b>Käufer / Long:</b> zahlt Prämie, hat ein <b>Recht</b>, Risiko begrenzt (max. die Prämie).<br><br><b>Verkäufer / Short:</b> erhält Prämie, hat eine <b>Pflicht</b>, muss Geld oder Aktien bereithalten.",
     "positionen long short"),

    ("Käufer & Verkäufer",
     "Was ist ein <b>Stillhalter</b>?",
    ...
    ("Käufer & Verkäufer",
     ...
     "Setzt auf <b>steigende</b> Kurse (Recht zu kaufen).",
     "positionen"),

    ("Käufer & Verkäufer",
     "Was erwartet ein <b>Long Put</b>?",
     "Setzt auf <b>fallende</b> Kurse (Recht zu verkaufen).",
     "positionen"),

    ("Käufer & Verkäufer",
     "Was wünscht sich ein <b>Short Call</b> (Verkäufer eines Calls)?",
     "Dass der Kurs <b>NICHT stark steigt</b> – dann verfällt der Call wertlos und die Prämie bleibt ihm.",
     "positionen"),

    ("Käufer & Verkäufer",
     "Was wünscht sich ein <b>Short Put</b> (Verkäufer eines Puts)?",
     "Dass der Kurs <b>NICHT stark fällt</b> – dann verfällt der Put wertlos und die Prämie bleibt ihm.",
     "positionen"),

    # --- 3. Preisbildung & Griechen ----------------------------------------
    ("Preis & Griechen",
     "Aus welchen zwei Bausteinen besteht die <b>Prämie</b>?",
     "<b>Prämie = Innerer Wert + Zeitwert</b><br><br>• Innerer Wert = schon „echtes Geld“ wert (nur bei ITM).<br>• Zeitwert = Aufschlag für Restlaufzeit &amp; Unsicherheit; schmilzt bis zum Verfall auf null.",
     "preis praemie"),

    ("Preis & Griechen",
     "Was ist der <b>innere Wert</b> einer Option?",
     "Der Teil der Prämie, der schon „echtes Geld“ wert ist – <b>nur bei ITM-Optionen</b> vorhanden.",
     "preis innerer-wert"),

    ("Preis & Griechen",
     "Was ist der <b>Zeitwert</b> einer Option?",
    ...
    ("Preis & Griechen",
     "Was misst <b>Theta</b>?",
     "Wie viel Wert die Option <b>pro Tag</b> durch Zeitablauf verliert (Zeitwertverfall).<br><br>🧠 Merkhilfe: „<b>T</b>ime“.",
     "preis griechen theta"),

    ("Preis & Griechen",
     "Was misst <b>Vega</b>?",
     "Wie stark die Prämie auf Änderungen der <b>Volatilität</b> reagiert.<br><br>🧠 Merkhilfe: „<b>V</b>olatilität“.",
     "preis griechen vega"),
    ...
    ("Preis & Griechen",
     "Wann beschleunigt sich der <b>Zeitwertverfall</b> stark?",
     "In den letzten <b>ca. 30 Tagen</b> vor Verfall.<br><br>Deshalb verkaufen Stillhalter oft Optionen mit <b>30–45 Tagen</b> Restlaufzeit.",
     "preis griechen theta"),

    ("Preis & Griechen",
     "Was ist <b>implizite Volatilität (IV)</b>?",
    ...
    ("Strategien",
     "Was ist die Grundidee eines <b>Cash-Secured Put (CSP)</b>?",
    ...
    ("Strategien",
     "Was ist die Grundidee eines <b>Covered Calls</b>?",
     "Du besitzt bereits <b>100 Aktien</b> und verkaufst darauf einen Call. Du kassierst Prämie und bist bereit, die Aktien zu einem höheren Preis (Strike) zu verkaufen. Der Call ist durch deine Aktien <b>gedeckt</b>.",
    ...
    ("Strategien",
     "Covered Call: <b>maximaler Gewinn</b>?",
    ...
    ("Strategien",
     ...
     "Der Gewinn ist nach oben <b>gedeckelt</b>. Steigt die Aktie stark (z.&nbsp;B. auf 70&nbsp;$), musst du trotzdem zum Strike (55&nbsp;$) verkaufen und verpasst den Rest.",
    ...
    ("Strategien",
     ...
     "Die regelmäßig kassierten <b>Prämien</b> aus dem Verkauf von Optionen (Stillhalten) – ein Zusatzeinkommen zusätzlich zur normalen Dividende.",
     "strategien wheel eselsbruecke"),

    # --- 5. IBKR-Umsetzung -------------------------------------------------
    ("IBKR-Umsetzung",
     "Warum ist <b>Interactive Brokers (IBKR)</b> bei Optionshändlern beliebt?",
     "• Günstige Gebühren<br>• Weltweiter Zugang (v.&nbsp;a. liquide US-Optionsmärkte)<br>• Professionelle Software<br>• Hohe Sicherheit durch strenge Regulierung",
     "ibkr"),

    ("IBKR-Umsetzung",
     "Unterschied <b>Cash-Konto</b> und <b>Margin-Konto</b>?",
    ...
    ("IBKR-Umsetzung",
     ...
     "Optionen haben oft eine <b>breite Geld-Brief-Spanne</b>. Bei einer Marktorder bekommst du den ungünstigsten Preis. Mit einer <b>Limit-Order</b> setzt du einen fairen Preis nahe dem Mittelkurs.",
     "ibkr order limit"),

    ("IBKR-Umsetzung",
     "Was bedeuten <b>Bid</b>, <b>Ask</b> und <b>Mid</b>?",
     "<b>Bid</b> = Preis, zu dem du sofort verkaufen kannst.<br><b>Ask</b> = Preis, zu dem du sofort kaufen kannst.<br><b>Mid</b> = Mitte dazwischen – hier solltest du dein Limit ansetzen.",
     "ibkr order"),

    ("IBKR-Umsetzung",
     "Grobe Gebühr für eine US-Aktienoption bei IBKR?",
     "Oft rund <b>0,65&nbsp;USD pro Kontrakt</b> (plus kleine Mindestgebühr pro Order). Prüfe die aktuellen Konditionen immer selbst.",
     "ibkr gebuehren"),

    ("IBKR-Umsetzung",
     "Warum brauchst du bei IBKR ein <b>Marktdaten-Abo</b>?",
    ...
    ("Verfall & Andienung",
     "Was bedeutet „<b>amerikanischer Typ</b>“ bei US-Aktienoptionen?",
     "Der Käufer darf <b>jederzeit</b> bis zum Verfall ausüben – nicht nur am letzten Tag.",
     "verfall typ"),

    ("Verfall & Andienung",
     "Was passiert, wenn die Option <b>wertlos (OTM)</b> ausläuft?",
     "Du musst <b>nichts tun</b> – die kassierte Prämie ist dein Gewinn.",
     "verfall otm"),

    ("Verfall & Andienung",
     "Was passiert, wenn die Option <b>im Geld (ITM)</b> ausläuft?",
     "Du wirst <b>angedient</b>: Du musst die Aktien liefern (Call) bzw. abnehmen (Put).",
     "verfall itm andienung"),

    ("Verfall & Andienung",
     "Was bedeutet eine Position <b>„rollen“</b> (Rolling)?",
    ...
    ("Verfall & Andienung",
     "Wann droht eine <b>vorzeitige Andienung</b> in der Praxis meist?",
     "Meist nur <b>kurz vor Verfall</b> oder rund um <b>Dividendentermine</b>.",
     "verfall andienung"),

    # --- 7. Risikomanagement & Anfängerfehler ------------------------------
    ("Risikomanagement",
     "Woher kommt laut den Quellen der Erfolg im Optionshandel?",
     "<b>Nicht</b> von der cleversten Strategie, sondern von <b>Disziplin und Risikomanagement</b>.",
     "risiko grundsatz"),

    ("Risikomanagement",
     "Regel: Wie groß sollten <b>Positionen</b> sein?",
     "<b>Klein.</b> Pro Trade nur einen kleinen Bruchteil des Kapitals einsetzen – so verkraftest du auch einen Rückschlag.",
     "risiko position"),
    ...
    ("Risikomanagement",
     ...
     "Sobald z.&nbsp;B. <b>50&nbsp;% des möglichen Gewinns</b> erreicht sind – sie kaufen die Option zurück. Das senkt das Risiko in der Schlussphase.",
     "risiko exit"),

    ("Risikomanagement",
     "Warum sollten Anfänger keine <b>nackten (ungedeckten) Calls</b> verkaufen?",
    ...
    ("Risikomanagement",
     ...
     "Zuerst <b>Paper Trading</b> (Demokonto) nutzen und alle Abläufe üben. Fehler kosten dort nichts.",
     "risiko papertrading"),

    ("Risikomanagement",
     "Häufiger Anfängerfehler rund um den <b>Faktor 100</b>?",
    ...
    ("Risikomanagement",
     ...
     "Als Einsteiger lieber <b>verkaufen</b> (Stillhalter) und <b>Theta</b> (Zeitwertverfall) für sich arbeiten lassen.",
     "risiko fehler"),
]
...
cloze = [
    ("Grundlagen",
     "Ein <b>Call</b> gibt das Recht, die Aktie zu {{c1::kaufen}}; ein <b>Put</b> gibt das Recht, die Aktie zu {{c2::verkaufen}}.",
     "", "cloze grundlagen"),

    ("Grundlagen",
     "1 Optionskontrakt = {{c1::100}} Aktien. Eine Prämie von 1,50&nbsp;$ entspricht also {{c2::150&nbsp;$}} pro Kontrakt.",
     "", "cloze grundlagen kontrakt"),

    ("Grundlagen",
     "Der Käufer einer Option hat ein {{c1::Recht}}, der Verkäufer (Stillhalter) hat eine {{c2::Pflicht}}.",
     "", "cloze positionen"),

    ("Preis & Griechen",
     "Prämie = {{c1::Innerer Wert}} + {{c2::Zeitwert}}.",
     "Der Zeitwert schmilzt bis zum Verfall auf null.", "cloze preis"),

    ("Preis & Griechen",
     "{{c1::Delta}} misst die Preisänderung pro 1&nbsp;$ Kursbewegung. {{c2::Theta}} misst den täglichen Zeitwertverlust. {{c3::Vega}} misst die Reaktion auf Volatilität.",
     "", "cloze griechen"),

    ("Preis & Griechen",
     "Hohe implizite Volatilität (IV) führt zu {{c1::hohen}} Prämien – für den Verkäufer {{c2::gut}}.",
     "", "cloze volatilitaet"),

    ("Strategien",
     "Beim <b>Cash-Secured Put</b> gilt: Breakeven = {{c1::Strike − Prämie}}, maximaler Gewinn = {{c2::die Prämie}}.",
     "Beispiel: Strike 50 $, Prämie 1,50 $ → Breakeven 48,50 $.", "cloze strategien csp"),

    ("Strategien",
     "Beim <b>Covered Call</b> ist der Gewinn nach oben {{c1::gedeckelt}}, weil du die Aktien zum {{c2::Strike}} verkaufen musst.",
     "", "cloze strategien covered-call"),

    ("Strategien",
     "Der Kreislauf aus Cash-Secured Put und Covered Call heißt {{c1::The Wheel}}; die kassierten Prämien nennt man die {{c2::zweite Dividende}}.",
     "", "cloze strategien wheel"),

    ("IBKR-Umsetzung",
     "Bei Optionen immer {{c1::Limit}}-Orders nutzen, nie {{c2::Market}}-Orders – wegen der breiten Geld-Brief-Spanne.",
     "", "cloze ibkr order"),
    ...
    ("Risikomanagement",
     "Verkaufe Puts nur auf Aktien, die du {{c1::wirklich besitzen willst}}, und halte die Positionsgröße {{c2::klein}}.",
     "", "cloze risiko"),
]
...
diagram = [
    ("Grundlagen",
     ...
     "Steigende Kurse erwartet → <b>Call</b> (Recht zu kaufen).<br>Fallende Kurse erwartet → <b>Put</b> (Recht zu verkaufen).",
     "diagramm grundlagen call put"),

    ("Käufer & Verkäufer",
     "Wie sehen die <b>vier Grundpositionen</b> eines Optionsgeschäfts aus?",
     "02_vier_grundpositionen.png",
     "Käufer (Long): <b>Long Call</b> / <b>Long Put</b>.<br>Verkäufer (Short): <b>Short Call</b> / <b>Short Put</b>.<br>Käufer hat das Recht, Verkäufer die Pflicht.",
     "diagramm positionen"),

    ("Preis & Griechen",
     "Woraus setzt sich der <b>Optionspreis</b> zusammen?",
     "03_preis_bausteine.png",
     "Prämie = <b>Innerer Wert</b> (Abstand Kurs–Strike, nur ITM) + <b>Zeitwert</b> (Restlaufzeit → Theta, IV → Vega, Zins → Rho).",
     "diagramm preis"),

    ("Strategien",
     "Wie läuft ein <b>Cash-Secured Put</b> ab (beide Ausgänge)?",
     "04_cash_secured_put.png",
     "Kurs über Strike → Put verfällt wertlos, Prämie bleibt.<br>Kurs unter Strike → Andienung, du kaufst die Aktien zum Wunschpreis (Einstand sinkt um die Prämie).",
     "diagramm strategien csp"),

    ("Strategien",
     "Wie läuft ein <b>Covered Call</b> ab (beide Ausgänge)?",
     "05_covered_call.png",
     "Kurs unter Strike → Call verfällt wertlos, du behältst Aktien + Prämie.<br>Kurs über Strike → Aktien werden zum Strike verkauft, Gewinn nach oben gedeckelt.",
    ...
    ("IBKR-Umsetzung",
     "Welchen <b>Kontotyp</b> wählst du bei IBKR – und warum?",
     "07_kontotyp.png",
    ...
    ("IBKR-Umsetzung",
     ...
     "08_order_ablauf.png",
     "Basiswert → Optionskette → Verfall (30–45 Tage) → Strike (z.&nbsp;B. Delta ~0,30) → Sell → <b>Limit</b>-Order nahe Mid → prüfen (×100!) → Transmit.",
     "diagramm ibkr order"),

    ("Verfall & Andienung",
     "Wie läuft <b>Ausübung und Andienung</b> ab?",
     "09_andienung_sequence.png",
     "Käufer übt aus (Exercise) → Clearingstelle (OCC) teilt dem Stillhalter die Pflicht zu (Assignment) → Stillhalter liefert/kauft 100 Aktien zum Strike. Die Prämie bleibt dem Stillhalter.",
     "diagramm verfall andienung"),

    ("Risikomanagement",
     "Was sind die Säulen des <b>Risikomanagements</b>?",
     "10_risikomanagement.png",
     "Positionsgröße klein · Diversifikation · nur Wunsch-Aktien · Timing bei hoher Volatilität · Gewinne früh mitnehmen (z.&nbsp;B. 50&nbsp;%).",
     "diagramm risiko"),
]
...
def main():
    ...
    total = len(basic_rows) + len(cloze_rows) + len(diagram_rows)
    print(f"\nGesamt: {total} Karten "
          f"({len(basic_rows)} Basic, {len(cloze_rows)} Cloze, {len(diagram_rows)} Diagramm)")
